          ...
          <Box sx={{ marginTop: "2vh" }}>
            ...
            >
              <CardContent>
                ...
                >
                  <Typography variant="body1" component="div" sx={{ color: "#4B56D2", alignContent: "center" }}>
                    Filtrar por:
                  </Typography>
                  <TextField
                    label="Monto mínimo"
                  ...
                  <FormControl variant="outlined" sx={{ minWidth: 120 }}>
                    ...
                    <Select value={concept} onChange={(e) => setConcept(e.target.value)} label="Concepto">
                      <MenuItem value="">
                        <em>-----</em>
                      </MenuItem>
                          ...
                          <ListItemText
                            ...
                            secondary={
                              <Box component="span">
                                <Box
                                  component="span"
                                  sx={{ color: "gray", fontSize: "0.875rem", display: "flex", justifyContent: "space-between", alignItems: "center" }}
                                >
                                  <Typography component="span">Fecha: {formattedDate}</Typography>
                                  <IconButton
