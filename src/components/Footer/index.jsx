...
const Footer = () => {
  ...
  return (
    ...
    {!token && <Grid container spacing={2} alignItems="center" className="footer-container" sx={{backgroundColor:"#F1F6F5", color:"#472183"}}>
    <Grid item xs={12}> <Typography variant="body2" align="center">
            <Copyright style={{ fontSize: 20 }} />Copyright © 2024 - Magic Dogs Alkywall
